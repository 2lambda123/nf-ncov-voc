process POSTPROCESSING {
  ...
  script:
      """
      rm -rf /scratch/mzanwar/COVID-MVP/nf_ncov_voc_viralai/nf-ncov-voc/latest_gvf/*
      ...
      rm -rf /scratch/mzanwar/COVID-MVP/nf_ncov_voc_viralai/nf-ncov-voc/latest_tsv/*
      ...
      rm -rf /scratch/mzanwar/COVID-MVP/nf_ncov_voc_viralai/nf-ncov-voc/latest_pdf/*
